        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
	            {{ link_to('index/index','<i class="fa fa-paw"></i> <span>PhalconPHP</span>','class':'site_title') }}
            </div>
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                {{ image_input("src": "../PhalconPHP-CMS/public/img/img.jpg","class": "img-circle profile_img") }}
              </div>
