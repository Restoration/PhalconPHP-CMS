        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="x_panel">
              <div class="x_title">
                <h2>Category Edit<small></small></h2>
					...
					{{hidden_field('category_id', 'value':category.category_id)}}
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          {{ text_field('category_name', 'class': 'form-control col-md-7 col-xs-12' , ' name':'category_name','required':'required','id':'category-name','data-parsley-trigger':'keyup','data-parsley-minlength':'1','data-parsley-maxlength':'60','data-parsley-minlength-message':'Enter within 60 characters.','value':category.category_name)}}
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          {{ text_field('category_slug', 'class': 'form-control col-md-7 col-xs-12' , ' name':'category_slug','required':'required','id':'category-slug','data-parsley-trigger':'keyup','data-parsley-minlength':'1','data-parsley-maxlength':'60','data-parsley-minlength-message':'Enter within 60 characters.','value':category.category_slug)}}
                        </div>
                      </div>
